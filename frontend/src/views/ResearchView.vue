  ...
  <div v-else-if="task">
    ...
    <div class="vp-card" style="margin-bottom: 24px">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px">
        ...
        <span style="font-family: var(--vp-font-family-mono); font-size: 14px; font-weight: 500; color: var(--vp-c-brand)">{{ task.progress }}%</span>
      </div>
    ...
    <div v-if="task.status === 'completed'" class="vp-card status-card status-completed">
      <h2>调研完成</h2>
    ...
    <div v-else-if="task.status === 'failed'" class="vp-card status-card status-failed">
      <h2 style="color: var(--vp-c-red)">调研失败</h2>
...
.status-failed {
  border-top: 3px solid var(--vp-c-red);
}
</style>
